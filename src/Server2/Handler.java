             		...
             		int stt=start;
          			...
          			act+=1;
         	    		try
         	           	...
         	           	{
         	           		System.out.println("\n"+rount.table[vt].name+": bi su co vo van 2, hien khong lien lac duoc\n");
         	           		vt++;
         	           		if (vt>rount.max-1)
         	           			vt=0;
   	   ...
   	   if (start==0)
           {
            	...
            	{	            	
	            	...
	            	{
	            		System.out.println("\n"+rount.table[vt].name+": bi su co chet tiet lang nhach 2, hien khong lien lac duoc\n");
	            		vt++;
	            		if (vt>rount.max-1)
	            			vt=0;
    		   ...
    		   start++;
	    		try
	           	...
	           	//bi su co
	           		...
	           		{
	           		System.out.println("\n"+rount.table[vt].name+": bi su co chan chet tiet 2, hien khong lien lac duoc\n");
	           		vt++;
	           		if (vt>rount.max-1)
	           			vt=0;
    		   ...
    		   start++;
	    		try
	           	...
	           	//bi su co
	           		...
	           		{
	           		System.out.println("\n"+rount.table[vt].name+": bi su co chi chi rua 2, hien khong lien lac duoc\n");
	           		vt++;
	           		if (vt>rount.max-1)
	           			vt=0;
